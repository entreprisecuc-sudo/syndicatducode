...
BASE_URL = (os.environ.get("REACT_APP_BACKEND_URL") or "https://syndicat-code-hub.preview.emergentagent.com").rstrip("/")
    ...
    def test_checkout_service_returns_url(self, admin_headers):
        ...
        r = requests.post(
            ...
            json={
                ...
                "origin_url": "https://syndicat-code-hub.preview.emergentagent.com",
