/**
 * Page Détail Membre
 * Affiche le profil complet d'un développeur + formulaire de contact
 */
...
import { 
  ...
  Send, CheckCircle, User, Mail, Phone, FileText
} from "lucide-react";
...
/**
 * Formulaire de contact pour contacter le développeur
 */
const ContactForm = ({ memberId, memberName }) => {
      ...
      <section className="px-4 pb-16">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Colonne gauche - Profil et projets */}
            ...
            <div className="lg:col-span-1">
              <div className="lg:sticky lg:top-24">
                <ContactForm memberId={memberId} memberName={displayName} />
              </div>
            </div>
          </div>
        </div>
