    ...
    <CitadelleLayout>
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8" data-testid="listing-detail">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-16 min-w-0">
            ...
            {/* Documents joints */}
            {documents.length > 0 && (
              <div className="p-6 rounded-2xl" style={{ background: "white", border: `1px solid ${CITADELLE_COLORS.border}`, boxShadow: "0 8px 30px rgba(15,39,71,0.18)" }}>
            ...
            {(() => {
              ...
              return (
                <div className="p-5 rounded-2xl" style={{ background: "white", border: `1px solid ${CITADELLE_COLORS.border}`, boxShadow: "0 8px 30px rgba(15,39,71,0.18)" }}>
          ...
          <div className="space-y-10">
            ...
            {/* Métriques clés */}
            <div className="p-5 rounded-2xl space-y-3" style={{ background: "white", border: `1px solid ${CITADELLE_COLORS.border}`, boxShadow: "0 8px 30px rgba(15,39,71,0.18)" }}>
      ...
      {offerModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.6)" }}>
          <div className="w-full max-w-md p-6 rounded-2xl" style={{ background: "white", border: `1px solid ${CITADELLE_COLORS.border}`, boxShadow: "0 8px 30px rgba(15,39,71,0.18)" }}>
