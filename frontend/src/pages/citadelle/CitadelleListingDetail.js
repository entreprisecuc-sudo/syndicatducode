    ...
    <CitadelleLayout>
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8" data-testid="listing-detail">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-16 min-w-0">
            ...
            {/* Documents joints */}
            {documents.length > 0 && (
              <div className="p-6 rounded-2xl" style={{ background: "#F5F7FA", border: "1px solid #B0BFCC", boxShadow: "0 2px 10px rgba(15,39,71,0.10)" }}>
            ...
            {(() => {
              ...
              return (
                <div className="p-5 rounded-2xl" style={{ background: "#F5F7FA", border: "1px solid #B0BFCC", boxShadow: "0 2px 10px rgba(15,39,71,0.10)" }}>
          ...
          <div className="space-y-10">
            ...
            {/* Métriques clés */}
            <div className="p-5 rounded-2xl space-y-3" style={{ background: "#F5F7FA", border: "1px solid #B0BFCC", boxShadow: "0 2px 10px rgba(15,39,71,0.10)" }}>
      ...
      {offerModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.6)" }}>
          <div className="w-full max-w-md p-6 rounded-2xl" style={{ background: "#F5F7FA", border: "1px solid #B0BFCC", boxShadow: "0 2px 10px rgba(15,39,71,0.10)" }}>
