...
export default function CitadelleMentionsLegales() {
  ...
  return (
    <CitadelleLayout>
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-14 blog-content" data-testid="mentions-legales-content">
        <ReactMarkdown remarkPlugins={[remarkGfm]}>{t('legalDocs.mentions_md')}</ReactMarkdown>
      </div>
    </CitadelleLayout>
  );
}
