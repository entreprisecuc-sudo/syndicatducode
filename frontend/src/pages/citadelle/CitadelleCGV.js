...
export default function CitadelleCGV() {
  ...
  return (
    <CitadelleLayout>
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-14 blog-content" data-testid="cgv-content">
        <ReactMarkdown remarkPlugins={[remarkGfm]}>{t('legalDocs.cgv_md')}</ReactMarkdown>
      </div>
    </CitadelleLayout>
  );
}
