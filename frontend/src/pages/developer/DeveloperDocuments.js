/**
 * Page Documents - Espace Développeur
 */
...
const DOCUMENTS = [
  {
    id: 1,
    title: "Charte du développeur partenaire",
    description: "Les règles et engagements du partenariat développeur avec Le Syndicat du Code.",
    type: "PDF",
    category: "Charte"
  },
  {
    id: 2,
    title: "Process de mission",
    description: "Comment se déroule une mission avec Le Syndicat : de la candidature à la livraison.",
    type: "PDF",
    category: "Guide"
  },
  {
    ...
    description: "Modalités de facturation, délais de paiement et conditions générales.",
    type: "PDF",
    ...
    <DashboardLayout>
      ...
      >
        ...
        <p className="text-sm" style={{ color: "var(--text-muted)" }}>
          Retrouvez ici tous les documents relatifs à votre partenariat développeur avec Le Syndicat du Code.
        </p>
      </div>
